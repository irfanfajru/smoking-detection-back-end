...
def detect(filePath, weights="yolov7.pt", imageSize=640, save_img=True):
    source, weights, view_img, save_txt, imgsz, trace = filePath, weights, opt.view_img, opt.save_txt, imageSize, not opt.no_trace
